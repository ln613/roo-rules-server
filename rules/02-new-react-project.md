...
- server side: create some test data in the todo collection in db, which represents some todo list items. When executing the seed function, you should add the env var MONGODB_URI to the command, since the seed file has no access to the .env file in the parent folder.
